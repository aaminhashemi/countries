...
const Index = () => {
    ...
    const filterCountries = (e) => {
        setFilteredCountries(countries.filter((item)=>item.region === e.target.value))
    }
    return (
        <>
            <Navbar className="mb-2" color={mode}>
                ...
                <NavbarText className="fa fa-moon-o" color={mode === "light" ? "dark" : "light"}>
                    <span onClick={handleModeChange}
                          className={mode === "light" ? "text-dark" : "text-light"}>{mode === "light" ? "Dark" : "Light"} Mode</span>
                </NavbarText>
            </Navbar>
                ...
                <Form className="">
                    <Row className="d-flex flex-wrap justify-content-between">
                        ...
                        <Col className="col-lg-3 col-xs-6 col-md-3 col-sm-6  pb-3">
                            <Input id="exampleSelect" name="select" type="select" onChange={filterCountries}>
